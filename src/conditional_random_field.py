...
def is_transition_allowed(
    ...
    elif constraint_type == "IO":
        if from_tag == "START":
            return to_tag in ("O", "I")
        if to_tag == "END":
            return from_tag in ("O", "I")
        return any(
            [
                # Can always transition to O or I-x
                to_tag in ("O", "I"),
                # Can only transition to I-x from I-x
                to_tag == "I" and from_tag == "I" and from_entity == to_entity,
            ]
        )
